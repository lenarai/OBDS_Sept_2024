...
#fastqc  --nogroup --threads 1 --extract -o /path/to/my_output_directory /path/to/my/sample_1.fastq.gz

#hisat2 --threads 12 \
#-x  /project/shared/resources/1_linux/genomes/Mus_musculus/Ensembl/GRCm38/Sequence/HISAT/mm10 \
#-1 /project/$USER/1_linux/rnaseq/fastq/ERR1755082_1.fastq.gz \
#-2 /project/$USER/1_linux/rnaseq/fastq/ERR1755082_2.fastq.gz \
#--rna-strandness RF \
#--summary-file mapped_reads/ERR1755082.stats.txt \
#-S mapped_reads/ERR1755082.sam

#samtools to generate a bam, sort and index it
#samtools  view (add an option to include header
#samtools sort
#samtools index

# -@ specified threads
#samtools view -@ 12 -b -h mapped_reads/ERR1755082.sam > mapped_reads/ERR1755082.bam
#samtools sort -@ 12 mapped_reads/ERR1755082.bam > mapped_reads/ERR1755082.sorted.bam
