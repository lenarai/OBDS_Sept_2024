...
# fastqc  --nogroup --threads 4 --extract -o /project/ndwr0113/1_linux/rnaseq/fastqc_slurm_exercise /project/ndwr0113/1_linux/rnaseq/fastq/*.fastq.gz
multiqc fastq_slurm_exercise/ERR1755082* -o /project/ndwr0113/1_linux/rnaseq/fastqc_slurm_exercise -n my_multiqc.html
